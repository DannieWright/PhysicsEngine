...
public class ContactManifoldBasic
{
   ...
   */
  public ContactManifoldBasic(Vector2D caContactManifoldA[], Vector2D cNormalA,
  ...
  public ContactManifoldBasic getSwap ()
  {
    return new ContactManifoldBasic(mcaContactManifoldB, mcNormalB,
